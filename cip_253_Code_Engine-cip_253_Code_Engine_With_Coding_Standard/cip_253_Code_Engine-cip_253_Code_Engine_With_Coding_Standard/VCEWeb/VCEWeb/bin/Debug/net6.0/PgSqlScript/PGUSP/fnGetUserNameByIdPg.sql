...
-- Description: This is for getting @ReplaceTableName based on @pkid using in_inputjson
-- ============================================= 
CREATE OR REPLACE PROCEDURE "@ReplaceSchema".spGet_@ReplacePROCEDUREName(
	in_inputjson TEXT,
...
EXCEPTION WHEN OTHERS THEN PERFORM spErrorLog('spGet_@ReplacePROCEDUREName',SQLERRM,SQLSTATE);
END;
$BODY$;
